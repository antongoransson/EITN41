...
class TestConverter(unittest.TestCase):
    ...
    def test_int_to_hex(self):
        int_nbr1 = 500
        int_nbr2 = 2897
        byte_array1 = int_to_bytes(int_nbr = int_nbr1, size = 4)
        byte_array2 = int_to_bytes(int_nbr = int_nbr2, size = 4)
    ...
    def test_int_to_bytesHash(self):
        int_nbr = 500
        byte_array = int_to_bytes(int_nbr = int_nbr, size = 4, byteorder='big')
